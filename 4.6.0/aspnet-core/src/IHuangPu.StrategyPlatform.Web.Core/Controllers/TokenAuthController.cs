...
using Abp.UI;
using IHuangPu.StrategyPlatform.Authentication.External;
...
using IHuangPu.StrategyPlatform.Models.TokenAuth;
using IHuangPu.StrategyPlatform.MultiTenancy;

namespace IHuangPu.StrategyPlatform.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : StrategyPlatformControllerBase
    {
